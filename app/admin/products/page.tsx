...
export default function ProductsPage() {
  ...
  const handleBulkAction = async () => {
    ...
    if (bulkAction === 'delete') {
      if (!confirm(`Naozaj chcete vymazat ${ids.length} produktov? Táto akcia je nevratná.`)) {
        return
      }
    }
    ...
    try {
      ...
      alert(`Hromadná akcia dokoncená:\n? Úspešne: ${successCount}\n? Chyby: ${errorCount}`)
  ...
  const handleExport = async () => {
    ...
    alert(`Export ${ids ? ids.length + ' vybraných' : 'všetkých'} produktov - funkcia bude dostupná coskoro`)
  }
    ...
    <div>
      ...
      <div className="filters-section">
        <div className="filters-header" onClick={() => setShowFilters(!showFilters)}>
          <div className="filters-toggle">
            <span>??</span>
            <span>Filtre a vyhladávanie</span>
            {hasActiveFilters && (
      ...
      <div className={`bulk-bar ${selectedIds.size > 0 ? 'has-selection' : ''}`}>
        ...
        >
          ...
          <option value="feature">? Oznacit ako odporúcané</option>
          <option value="unfeature">? Zrušit odporúcané</option>
        ...
        >
          {bulkProcessing ? 'Spracúvam...' : 'Vykonat'}
        </button>
        ...
        <div className="empty-state">
          ...
          <p>
            {hasActiveFilters 
              ...
              : 'Zatial nemáte žiadne produkty. Pridajte prvý produkt alebo importujte z feedu.'
            }
          </p>
          {hasActiveFilters ? (
                    ...
                    <div className="product-cell">
                      ...
                      <div className="product-info">
                        <div className="product-title">
                          ...
                          {product.is_featured && <span title="Odporúcaný">?</span>}
                        </div>
